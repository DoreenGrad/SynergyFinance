package com.example.studentsbudgetingapp.Activities;
...
import com.example.studentsbudgetingapp.R;
...
import com.example.studentsbudgetingapp.Adapters.TodayItemsAdapter;
import com.example.studentsbudgetingapp.Model.Data;
...
public class MonthSpendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayItemsAdapter = new TodayItemsAdapter(MonthSpendingActivity.this, myDataList);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("Total day's spending: R "+ totalAmount);
                }
            }
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (budgetItem.equalsIgnoreCase("select item")){
                    Toast.makeText(MonthSpendingActivity.this, "Please select a valid item", Toast.LENGTH_SHORT).show();
                }
                else {
                    loader.setTitle("Adding Item");
                    loader.setMessage("Please wait, the item is being added...");
                    ...
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(MonthSpendingActivity.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(MonthSpendingActivity.this, "Failed to add Item", Toast.LENGTH_SHORT).show();
                            }
                            loader.dismiss();
                        }
                    });
