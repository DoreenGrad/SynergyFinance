...
import com.example.studentsbudgetingapp.Adapters.WeekItemsAdapter;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This Months spending: R "+ totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This week's spending: R "+ totalAmount);
                }
            }
